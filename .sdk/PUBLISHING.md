...
|---|---|---|
| `ts/` | @voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk \
      --repository voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk --id=<id>` removes it.
