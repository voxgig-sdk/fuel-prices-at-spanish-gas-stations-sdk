...
// FuelPricesAtSpanishGasStations SDK cache feature
...
class FuelPricesAtSpanishGasStationsCacheFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    private function _through(FuelPricesAtSpanishGasStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
