...
// FuelPricesAtSpanishGasStations SDK clienttrack feature
...
class FuelPricesAtSpanishGasStationsClienttrackFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    public function PostConstruct(FuelPricesAtSpanishGasStationsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FuelPricesAtSpanishGasStations-SDK';
