...
// FuelPricesAtSpanishGasStations SDK netsim feature
...
class FuelPricesAtSpanishGasStationsNetsimFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    private function _simulate(FuelPricesAtSpanishGasStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FuelPricesAtSpanishGasStationsContext $ctx, array $applied): void
    {
        $client = $this->client;
