...
// FuelPricesAtSpanishGasStations SDK proxy feature
...
class FuelPricesAtSpanishGasStationsProxyFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    public function init(FuelPricesAtSpanishGasStationsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FuelPricesAtSpanishGasStationsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
