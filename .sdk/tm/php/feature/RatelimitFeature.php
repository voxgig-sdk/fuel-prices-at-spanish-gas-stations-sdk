...
// FuelPricesAtSpanishGasStations SDK ratelimit feature
...
class FuelPricesAtSpanishGasStationsRatelimitFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    private function _acquire(FuelPricesAtSpanishGasStationsContext $ctx): void
    {
    ...
    private function _track(FuelPricesAtSpanishGasStationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
