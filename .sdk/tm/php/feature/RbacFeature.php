...
// FuelPricesAtSpanishGasStations SDK rbac feature
...
class FuelPricesAtSpanishGasStationsRbacFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    private function _required(FuelPricesAtSpanishGasStationsContext $ctx): ?string
    {
    ...
    private function _reject(FuelPricesAtSpanishGasStationsContext $ctx, string $required): void
    {
    ...
    private function _track(FuelPricesAtSpanishGasStationsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
