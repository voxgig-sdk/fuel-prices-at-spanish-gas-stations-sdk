...
// FuelPricesAtSpanishGasStations SDK streaming feature
...
class FuelPricesAtSpanishGasStationsStreamingFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    private function _iterate(FuelPricesAtSpanishGasStationsResult $result): \Generator
    {
    ...
    private function _streamable(FuelPricesAtSpanishGasStationsContext $ctx): bool
    {
