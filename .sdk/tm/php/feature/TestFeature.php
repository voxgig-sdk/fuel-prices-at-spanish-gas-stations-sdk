...
// FuelPricesAtSpanishGasStations SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FuelPricesAtSpanishGasStationsTestFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    public function init(FuelPricesAtSpanishGasStationsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FuelPricesAtSpanishGasStationsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FuelPricesAtSpanishGasStationsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FuelPricesAtSpanishGasStationsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FuelPricesAtSpanishGasStationsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = FuelPricesAtSpanishGasStationsParam::call($ctx, $k);
