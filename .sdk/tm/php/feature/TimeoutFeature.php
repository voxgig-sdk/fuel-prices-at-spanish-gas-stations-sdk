...
// FuelPricesAtSpanishGasStations SDK timeout feature
...
class FuelPricesAtSpanishGasStationsTimeoutFeature extends FuelPricesAtSpanishGasStationsBaseFeature
{
    ...
    private function _with_timeout(FuelPricesAtSpanishGasStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FuelPricesAtSpanishGasStationsContext $_ctx, float $ms): void
    {
        $client = $this->client;
