...
// FuelPricesAtSpanishGasStations SDK pipeline test
//
...
{
    private static function utility(): FuelPricesAtSpanishGasStationsUtility
    {
        return new FuelPricesAtSpanishGasStationsUtility();
    }
    ...
    private static function ctx(array $over = []): FuelPricesAtSpanishGasStationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FuelPricesAtSpanishGasStationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FuelPricesAtSpanishGasStationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FuelPricesAtSpanishGasStationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FuelPricesAtSpanishGasStationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FuelPricesAtSpanishGasStationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FuelPricesAtSpanishGasStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FuelPricesAtSpanishGasStationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FuelPricesAtSpanishGasStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FuelPricesAtSpanishGasStationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FuelPricesAtSpanishGasStationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FuelPricesAtSpanishGasStationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FuelPricesAtSpanishGasStationsResponse([]),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FuelPricesAtSpanishGasStationsSpec([]),
            'response' => null,
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's']),
            'response' => new FuelPricesAtSpanishGasStationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's']),
            'response' => new FuelPricesAtSpanishGasStationsResponse(self::resp(200, ['v' => 1])),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's']),
            'response' => new FuelPricesAtSpanishGasStationsResponse(self::resp(200, ['v' => 2])),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FuelPricesAtSpanishGasStationsMakeResponse::call($ctx);
    ...
    {
        $preset = new FuelPricesAtSpanishGasStationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FuelPricesAtSpanishGasStationsSpec([]),
            'response' => new FuelPricesAtSpanishGasStationsResponse([]),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ...
        [$got, $err] = FuelPricesAtSpanishGasStationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FuelPricesAtSpanishGasStationsResult([])]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FuelPricesAtSpanishGasStationsSpec([]), 'result' => null]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's']),
            'result' => new FuelPricesAtSpanishGasStationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FuelPricesAtSpanishGasStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FuelPricesAtSpanishGasStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's']),
            'result' => new FuelPricesAtSpanishGasStationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FuelPricesAtSpanishGasStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FuelPricesAtSpanishGasStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FuelPricesAtSpanishGasStationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FuelPricesAtSpanishGasStationsSpec([]),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FuelPricesAtSpanishGasStationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FuelPricesAtSpanishGasStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FuelPricesAtSpanishGasStationsError('boom', 'boom');
        $utility->fetcher = function (FuelPricesAtSpanishGasStationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FuelPricesAtSpanishGasStationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FuelPricesAtSpanishGasStationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FuelPricesAtSpanishGasStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FuelPricesAtSpanishGasStationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FuelPricesAtSpanishGasStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FuelPricesAtSpanishGasStationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FuelPricesAtSpanishGasStationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FuelPricesAtSpanishGasStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FuelPricesAtSpanishGasStationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FuelPricesAtSpanishGasStationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FuelPricesAtSpanishGasStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FuelPricesAtSpanishGasStationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FuelPricesAtSpanishGasStationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FuelPricesAtSpanishGasStationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FuelPricesAtSpanishGasStationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FuelPricesAtSpanishGasStationsResult(['ok' => false])]);
        $this->expectException(FuelPricesAtSpanishGasStationsError::class);
        FuelPricesAtSpanishGasStationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FuelPricesAtSpanishGasStationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FuelPricesAtSpanishGasStationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FuelPricesAtSpanishGasStationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FuelPricesAtSpanishGasStationsBaseFeature();
        $b = new FuelPricesAtSpanishGasStationsBaseFeature();
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, $a);
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FuelPricesAtSpanishGasStationsBaseFeature
    {
        $f = new FuelPricesAtSpanishGasStationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, self::named_feature('a'));
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, $replace);
        ...
        FuelPricesAtSpanishGasStationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FuelPricesAtSpanishGasStationsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FuelPricesAtSpanishGasStationsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FuelPricesAtSpanishGasStationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FuelPricesAtSpanishGasStationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FuelPricesAtSpanishGasStationsResponse(['headers' => null]),
            'result' => new FuelPricesAtSpanishGasStationsResult([]),
        ]);
        FuelPricesAtSpanishGasStationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FuelPricesAtSpanishGasStationsResultBody::call($ctx);
