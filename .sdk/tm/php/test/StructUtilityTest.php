...
// FuelPricesAtSpanishGasStations SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FuelPricesAtSpanishGasStationsOmni::makeStructRunner(
    ...
    {
        return FuelPricesAtSpanishGasStationsOmni::objmodel(FuelPricesAtSpanishGasStationsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return FuelPricesAtSpanishGasStationsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return FuelPricesAtSpanishGasStationsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FuelPricesAtSpanishGasStationsOmni::structfix($now, Struct::undef()))
                        !== json_encode(FuelPricesAtSpanishGasStationsOmni::structfix($val, Struct::undef()))) {
