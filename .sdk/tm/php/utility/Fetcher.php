...
// FuelPricesAtSpanishGasStations SDK utility: fetcher

class FuelPricesAtSpanishGasStationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FuelPricesAtSpanishGasStationsSDK/1.0)';
    ...
    public static function call(FuelPricesAtSpanishGasStationsContext $ctx, string $fullurl, array $fetchdef): array
    {
