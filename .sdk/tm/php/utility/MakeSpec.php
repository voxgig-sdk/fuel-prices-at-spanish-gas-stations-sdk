...
// FuelPricesAtSpanishGasStations SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class FuelPricesAtSpanishGasStationsMakeSpec
{
    public static function call(FuelPricesAtSpanishGasStationsContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = FuelPricesAtSpanishGasStationsGraphql::CONTENT_TYPE;
        } else {
