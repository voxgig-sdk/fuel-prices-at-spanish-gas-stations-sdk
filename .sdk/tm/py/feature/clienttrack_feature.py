...
# are never clobbered.
class FuelPricesAtSpanishGasStationsClienttrackFeature(FuelPricesAtSpanishGasStationsBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.0.1"
    ...
    def _name(self):
        name = self.options.get("clientName") or "FuelPricesAtSpanishGasStations-SDK"
