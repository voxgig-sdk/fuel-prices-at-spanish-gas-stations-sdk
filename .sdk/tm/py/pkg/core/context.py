...
from projectname_sdk.core.control import FuelPricesAtSpanishGasStationsControl
...
class FuelPricesAtSpanishGasStationsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FuelPricesAtSpanishGasStationsControl()
        ...
        if isinstance(sp, FuelPricesAtSpanishGasStationsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FuelPricesAtSpanishGasStationsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FuelPricesAtSpanishGasStationsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FuelPricesAtSpanishGasStationsOperation({})
    ...
    def make_error(self, code, msg):
        return FuelPricesAtSpanishGasStationsError(code, msg, self)
