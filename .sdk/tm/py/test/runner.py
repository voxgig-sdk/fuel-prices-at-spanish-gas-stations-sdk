...
class FuelPricesAtSpanishGasStationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FuelPricesAtSpanishGasStationsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FuelPricesAtSpanishGasStationsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FuelPricesAtSpanishGasStationsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
