# FuelPricesAtSpanishGasStations SDK feature corpus test
#
...
def _client(kase):
    ...
    FuelPricesAtSpanishGasStationsSDK(...), not FuelPricesAtSpanishGasStationsSDK.test(...): the `test` feature is
    ...
    return FuelPricesAtSpanishGasStationsSDK(opts)
