...
AQL-driven CLI and REPL for the FuelPricesAtSpanishGasStations SDK. Positional arguments are
...
```sh
go build -o fuel-prices-at-spanish-gas-stations-cli ./...
```
...
./fuel-prices-at-spanish-gas-stations-cli list dataset
./fuel-prices-at-spanish-gas-stations-cli load 1 dataset
./fuel-prices-at-spanish-gas-stations-cli load '{id:1}' dataset
