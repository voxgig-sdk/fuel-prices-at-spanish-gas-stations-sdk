// Command FuelPricesAtSpanishGasStations-cli is a CLI + REPL for the FuelPricesAtSpanishGasStations SDK,
...
const prompt = "fuel-prices-at-spanish-gas-stations"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "dataset distribution"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FUEL_PRICES_AT_SPANISH_GAS_STATIONS_APIKEY (api key), FUEL_PRICES_AT_SPANISH_GAS_STATIONS_BASE (base url override)")
