...
func registerSDKWords(r *eng.Registry, client *sdk.FuelPricesAtSpanishGasStationsSDK) {
...
func runOp(client *sdk.FuelPricesAtSpanishGasStationsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
