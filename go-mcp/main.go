// Command FuelPricesAtSpanishGasStations-mcp is an MCP server exposing the FuelPricesAtSpanishGasStations
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FuelPricesAtSpanishGasStations_list  — list records of an entity
//	FuelPricesAtSpanishGasStations_load  — load a single record of an entity
//
