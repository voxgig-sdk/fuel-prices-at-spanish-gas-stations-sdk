...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dataset | distribution"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FuelPricesAtSpanishGasStationsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fuel-prices-at-spanish-gas-stations_list",
		Description: "List records from FuelPricesAtSpanishGasStations. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fuel-prices-at-spanish-gas-stations_load",
		Description: "Load a single record from FuelPricesAtSpanishGasStations. " +
...
func runOp(client *sdk.FuelPricesAtSpanishGasStationsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FuelPricesAtSpanishGasStationsSDK, name string) (sdk.FuelPricesAtSpanishGasStationsEntity, error) {
	switch strings.ToLower(name) {
	case "dataset":
		return client.Dataset(nil), nil
	case "distribution":
		return client.Distribution(nil), nil
