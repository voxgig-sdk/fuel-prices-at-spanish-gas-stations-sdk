# FuelPricesAtSpanishGasStations Golang SDK Reference

Complete API reference for the FuelPricesAtSpanishGasStations Golang SDK.
...
#### `Test() *FuelPricesAtSpanishGasStationsSDK`
...
#### `TestSDK(testopts, sdkopts map[string]any) *FuelPricesAtSpanishGasStationsSDK`
...
#### `Dataset(data map[string]any) FuelPricesAtSpanishGasStationsEntity`

Create a new `Dataset` entity instance. Pass `nil` for no initial data.

#### `Distribution(data map[string]any) FuelPricesAtSpanishGasStationsEntity`
