...
type FuelPricesAtSpanishGasStationsSDK struct {
	Mode     string
...
func NewFuelPricesAtSpanishGasStationsSDK(options map[string]any) *FuelPricesAtSpanishGasStationsSDK {
	sdk := &FuelPricesAtSpanishGasStationsSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *FuelPricesAtSpanishGasStationsSDK) OptionsMap() map[string]any {
...
func (sdk *FuelPricesAtSpanishGasStationsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FuelPricesAtSpanishGasStationsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FuelPricesAtSpanishGasStationsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FuelPricesAtSpanishGasStationsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FuelPricesAtSpanishGasStationsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FuelPricesAtSpanishGasStationsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FuelPricesAtSpanishGasStationsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FuelPricesAtSpanishGasStationsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FuelPricesAtSpanishGasStationsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FuelPricesAtSpanishGasStationsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FuelPricesAtSpanishGasStationsSDK {
	...
	sdk := NewFuelPricesAtSpanishGasStationsSDK(sdkopts)
	sdk.Mode = "test"
