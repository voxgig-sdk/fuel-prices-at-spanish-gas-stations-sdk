...
import (
	...
	vs "github.com/voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk/go/utility/struct"
)

type DistributionEntity struct {
	name    string
	client  *core.FuelPricesAtSpanishGasStationsSDK
...
func NewDistributionEntity(client *core.FuelPricesAtSpanishGasStationsSDK, entopts map[string]any) *DistributionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DistributionEntity) GetName() string { return e.name }
...
func (e *DistributionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DistributionEntity) Deleted() bool {
	return e.deleted
}


func (e *DistributionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDistributionEntity(e.client, opts)
}

func (e *DistributionEntity) Data(args ...any) any {
...
func (e *DistributionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Distribution; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DistributionEntity) DataTyped(data ...Distribution) Distribution {
	if len(data) > 0 {
		return typedFrom[Distribution](e.Data(asMap(data[0])))
	}
	return typedFrom[Distribution](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Distribution (all fields
// optional at the wire level).
func (e *DistributionEntity) MatchTyped(match ...Distribution) Distribution {
	if len(match) > 0 {
		return typedFrom[Distribution](e.Match(asMap(match[0])))
	}
	return typedFrom[Distribution](e.Match())
}
...
func (e *DistributionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DistributionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DistributionLoadMatch and returns an Distribution. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DistributionEntity) LoadTyped(reqmatch DistributionLoadMatch, ctrl map[string]any) (Distribution, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Distribution{}, err
	}
	return typedFrom[Distribution](res), nil
}



func (e *DistributionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DistributionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DistributionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DistributionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DistributionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
