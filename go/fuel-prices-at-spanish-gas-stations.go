...
import (
	...
	"github.com/voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk/go/entity"
	"github.com/voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk/go/feature"
	_ "github.com/voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk/go/utility"
)
...
// instead of `sdk.NewFuelPricesAtSpanishGasStationsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FuelPricesAtSpanishGasStationsSDK  { return NewFuelPricesAtSpanishGasStationsSDK(nil) }
func Test() *FuelPricesAtSpanishGasStationsSDK { return TestSDK(nil, nil) }
