...
func TestDistributionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		distributionRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.distribution")))
...
func distributionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_DISTRIBUTION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_DISTRIBUTION_ENTID"])
