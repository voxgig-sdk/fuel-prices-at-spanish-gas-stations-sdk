# FuelPricesAtSpanishGasStations Lua SDK Reference

Complete API reference for the FuelPricesAtSpanishGasStations Lua SDK.
...
```lua
local result, err = client:Distribution(nil):load({ id = "distribution_id" }, nil)
```
