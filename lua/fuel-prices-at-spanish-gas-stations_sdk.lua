...
require("fuel-prices-at-spanish-gas-stations_types")
...
local FuelPricesAtSpanishGasStationsSDK = {}
FuelPricesAtSpanishGasStationsSDK.__index = FuelPricesAtSpanishGasStationsSDK
...
FuelPricesAtSpanishGasStationsSDK._make_feature = _make_feature


function FuelPricesAtSpanishGasStationsSDK.new(options)
  local self = setmetatable({}, FuelPricesAtSpanishGasStationsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FuelPricesAtSpanishGasStationsSDK:options_map()
...
function FuelPricesAtSpanishGasStationsSDK:get_utility()
  return Utility.copy(self._utility)
end


function FuelPricesAtSpanishGasStationsSDK:get_root_ctx()
  return self._rootctx
end


function FuelPricesAtSpanishGasStationsSDK:prepare(fetchargs)
...
function FuelPricesAtSpanishGasStationsSDK:direct(fetchargs)
...
function FuelPricesAtSpanishGasStationsSDK:_op_allowed(op)
  local allow = vs.getpath(self.options, "allow.op")
  return type(allow) == "string" and allow:find(op, 1, true) ~= nil
end


function FuelPricesAtSpanishGasStationsSDK:_op_denied(op)
  local allow = vs.getpath(self.options, "allow.op")
  if type(allow) ~= "string" then allow = "" end
  return {
    ok = false,
    err = "FuelPricesAtSpanishGasStationsSDK: " .. op .. ": operation not allowed by" ..
...
-- by passing it.
function FuelPricesAtSpanishGasStationsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FuelPricesAtSpanishGasStationsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FuelPricesAtSpanishGasStationsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FuelPricesAtSpanishGasStationsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FuelPricesAtSpanishGasStationsSDK.new(sdkopts)
  sdk.mode = "test"
...
return FuelPricesAtSpanishGasStationsSDK
