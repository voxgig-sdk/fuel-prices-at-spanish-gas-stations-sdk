...
describe("DatasetEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_DATASET_ENTID JSON to run live")
      return
    end
...
function dataset_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_DATASET_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_DATASET_ENTID"])
