...
describe("DistributionDirect", function()
  it("should direct-load-distribution", function()
    local setup = distribution_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-distribution", setup.live and "live" or "unit")
...
function distribution_direct_setup(mockres)
