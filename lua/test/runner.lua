...
function runner.env_override(m)
  local live = runner.getenv("FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_LIVE")
  local override = runner.getenv("FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_EXPLAIN")
