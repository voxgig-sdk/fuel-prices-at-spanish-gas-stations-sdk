...
The PHP SDK for the FuelPricesAtSpanishGasStations API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->FuelPricesAtSpanishGasStations(null)->load(
    ["id" => "test01"], null
);
