...
// FuelPricesAtSpanishGasStations SDK utility type

class FuelPricesAtSpanishGasStationsUtility
{
    ...
    public static function copy(FuelPricesAtSpanishGasStationsUtility $src): FuelPricesAtSpanishGasStationsUtility
    {
        $u = new FuelPricesAtSpanishGasStationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
