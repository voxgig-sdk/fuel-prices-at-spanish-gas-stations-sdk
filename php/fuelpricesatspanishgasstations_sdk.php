...
class FuelPricesAtSpanishGasStationsSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = FuelPricesAtSpanishGasStationsHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = FuelPricesAtSpanishGasStationsHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!FuelPricesAtSpanishGasStationsFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, FuelPricesAtSpanishGasStationsFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return FuelPricesAtSpanishGasStationsUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = FuelPricesAtSpanishGasStationsHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = FuelPricesAtSpanishGasStationsHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = FuelPricesAtSpanishGasStationsHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new FuelPricesAtSpanishGasStationsError($op . "_allow",
                "FuelPricesAtSpanishGasStationsSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = FuelPricesAtSpanishGasStationsHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new FuelPricesAtSpanishGasStationsError("graphql_error",
                "FuelPricesAtSpanishGasStationsSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Distribution($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_distribution === null) {
                $this->_distribution = new DistributionEntity($this, null);
            }
            return $this->_distribution;
        }
        return new DistributionEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new FuelPricesAtSpanishGasStationsSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
