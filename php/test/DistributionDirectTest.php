...
class DistributionDirectTest extends TestCase
{
    public function test_direct_load_distribution(): void
    {
        $setup = distribution_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-distribution", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
