...
// FuelPricesAtSpanishGasStations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FuelPricesAtSpanishGasStationsSDK::test)
...
{
    private const SDK_CLASS = 'FuelPricesAtSpanishGasStationsSDK';
    ...
    private const SDK_BASE = 'fuelpricesatspanishgasstations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../fuelpricesatspanishgasstations_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
