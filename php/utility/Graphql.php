...
// FuelPricesAtSpanishGasStations SDK utility: graphql
//
...
class FuelPricesAtSpanishGasStationsGraphql
{
    ...
    // equivalent.
    public static function body(FuelPricesAtSpanishGasStationsContext $ctx): mixed
    {
    ...
    public static function errors(FuelPricesAtSpanishGasStationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
