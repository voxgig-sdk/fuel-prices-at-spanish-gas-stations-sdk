...
// FuelPricesAtSpanishGasStations SDK utility: make_options

class FuelPricesAtSpanishGasStationsMakeOptions
{
    ...
    public static function call(FuelPricesAtSpanishGasStationsContext $ctx): array
    {
        ...
        //
        // `FuelPricesAtSpanishGasStationsSchema::optspec()` is built from the model:
        ...
        $optspec = FuelPricesAtSpanishGasStationsSchema::optspec();
