# FuelPricesAtSpanishGasStations Python SDK



The Python SDK for the FuelPricesAtSpanishGasStations API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/fuel-prices-at-spanish-gas-stations-sdk/releases)) or
...
```
py/
├── fuelpricesatspanishgasstations_sdk.py         -- Main SDK module
