...
The Python SDK for the FuelPricesAtSpanishGasStations API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.FuelPricesAtSpanishGasStations(None).load(
    {"id": "test01"}, None
)
