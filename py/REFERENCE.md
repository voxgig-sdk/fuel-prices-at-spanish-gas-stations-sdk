# FuelPricesAtSpanishGasStations Python SDK Reference

Complete API reference for the FuelPricesAtSpanishGasStations Python SDK.
...
#### `FuelPricesAtSpanishGasStationsSDK.test(testopts=None, sdkopts=None)`
...
Create a new `DistributionEntity` instance. Pass `None` for no initial data.
...
Create a new `DistributionEntity` instance with the same options.
