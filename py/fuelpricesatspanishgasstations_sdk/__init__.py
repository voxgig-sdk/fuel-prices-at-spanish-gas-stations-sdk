...
from fuelpricesatspanishgasstations_sdk.utility import register

# Load features
from fuelpricesatspanishgasstations_sdk.feature.base_feature import FuelPricesAtSpanishGasStationsBaseFeature
from fuelpricesatspanishgasstations_sdk.features import _has_feature, _make_feature
...
class FuelPricesAtSpanishGasStationsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FuelPricesAtSpanishGasStationsUtility()
        self._utility = utility

        from fuelpricesatspanishgasstations_sdk.config import shared_config
    ...
    def get_utility(self):
        return FuelPricesAtSpanishGasStationsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FuelPricesAtSpanishGasStationsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Dataset(self, data=None) -> "DatasetEntity":
        ...
        from fuelpricesatspanishgasstations_sdk.entity.dataset_entity import DatasetEntity
    ...
    def Distribution(self, data=None) -> "DistributionEntity":
        ...
        from fuelpricesatspanishgasstations_sdk.entity.distribution_entity import DistributionEntity
