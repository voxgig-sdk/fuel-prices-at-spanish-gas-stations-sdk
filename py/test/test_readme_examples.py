# FuelPricesAtSpanishGasStations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FuelPricesAtSpanishGasStationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FuelPricesAtSpanishGasStationsSDK(...) and FuelPricesAtSpanishGasStationsSDK.test(...) become
#      FuelPricesAtSpanishGasStationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fuelpricesatspanishgasstations_sdk"
_SDK_CLASS = "FuelPricesAtSpanishGasStationsSDK"
