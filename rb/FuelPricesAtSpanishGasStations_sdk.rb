...
require_relative 'FuelPricesAtSpanishGasStations_types'
...
class FuelPricesAtSpanishGasStationsSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = FuelPricesAtSpanishGasStationsHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = FuelPricesAtSpanishGasStationsHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, FuelPricesAtSpanishGasStationsFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    FuelPricesAtSpanishGasStationsUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = FuelPricesAtSpanishGasStationsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = FuelPricesAtSpanishGasStationsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = FuelPricesAtSpanishGasStationsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => FuelPricesAtSpanishGasStationsError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue FuelPricesAtSpanishGasStationsError => err
    ...
    if fetched.is_a?(Hash)
      status = FuelPricesAtSpanishGasStationsHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = FuelPricesAtSpanishGasStationsError.new(
        "graphql_error", "FuelPricesAtSpanishGasStationsSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = FuelPricesAtSpanishGasStationsSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
