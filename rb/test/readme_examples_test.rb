# FuelPricesAtSpanishGasStations SDK — README + REFERENCE example snippet tests.
#
...
#      (FuelPricesAtSpanishGasStationsSDK.test) seeded with an in-memory fixture for every
