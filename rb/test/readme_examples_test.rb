...
#      offline in seeded test mode (FuelPricesAtSpanishGasStationsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FuelPricesAtSpanishGasStations_sdk.rb")
  SDK_CLASS = "FuelPricesAtSpanishGasStationsSDK"
  ...
  SDK_BASE = "FuelPricesAtSpanishGasStations_sdk"
