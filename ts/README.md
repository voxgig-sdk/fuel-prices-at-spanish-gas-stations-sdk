...
The TypeScript SDK for the FuelPricesAtSpanishGasStations API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new FuelPricesAtSpanishGasStationsSDK({ apikey: '...' })
