# FuelPricesAtSpanishGasStations TypeScript SDK Reference

Complete API reference for the FuelPricesAtSpanishGasStations TypeScript SDK.
...
```ts
new FuelPricesAtSpanishGasStationsSDK(options?: object)
```
...
#### `FuelPricesAtSpanishGasStationsSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FuelPricesAtSpanishGasStationsSDK` instance in test mode.
...
Create a new `Distribution` entity instance.
...
**Returns:** `DistributionEntity` instance.
...
Alias for `FuelPricesAtSpanishGasStationsSDK.test()`.
...
Return the parent `FuelPricesAtSpanishGasStationsSDK` instance.
