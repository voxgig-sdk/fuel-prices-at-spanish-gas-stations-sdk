...
(0, node_test_1.describe)('DistributionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FuelPricesAtSpanishGasStationsSDK({
    ...
    (0, node_test_1.test)('direct-load-distribution', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-distribution', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FuelPricesAtSpanishGasStationsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FUEL_PRICES_AT_SPANISH_GAS_STATIONS_TEST_DISTRIBUTION_ENTID'];
    ...
    const client = new __1.FuelPricesAtSpanishGasStationsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DistributionDirect.test.js.map