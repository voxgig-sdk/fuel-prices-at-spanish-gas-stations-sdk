...
const FuelPricesAtSpanishGasStationsError_1 = require("./FuelPricesAtSpanishGasStationsError");
...
class Context {
    ...
    error(code, msg) {
        return new FuelPricesAtSpanishGasStationsError_1.FuelPricesAtSpanishGasStationsError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
